...
const TitleWithSection = Object.assign(Title, {
  Section: TitleSection,
});

const StyledContentSectionBase = styled.section`
  &:nth-of-type(even) {
...
const StyledContentSection = Object.assign(StyledContentSectionBase, {
  Wrapper,
  Pane,
