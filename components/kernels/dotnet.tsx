  ...
  <ContentSection>
    <ContentSection.Pane $full>
      ...
      >
        ...
        <p>
          Install{" "}
          <a href="https://dotnet.microsoft.com/download">.NET Core SDK</a> to
          your system.
        </p>
        <div className="columns">
          <div className="column">
            <h4>
              First, install the .NET Core SDK 3.1. Then use the command line
              tool to install the global tool.
            </h4>
