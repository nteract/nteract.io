...
const PageHeader = styled.div`
  ...
  background-image: url(/public/hero_header_bg@2x.png);
  ...
  ${PageHeaderWrapper} {
    ...
    overflow: hidden;
    h1 {
      animation-delay: ${parseFloat(animations.timingAnimationDelay)}s;
      color: white;
    }
    ${handheld(css`
  ...
  ${Left} {
    ...
    p,
    ${StyledButtons} {
      animation-delay: ${parseFloat(animations.timingAnimationDelay) / 3}s;
    }
    ${tabletUp(css`
      max-width: 550px;
    `)}
...
const PageHeaderWithSubComponents = Object.assign(PageHeader, {
  Left,
  Right,
  Wrapper: PageHeaderWrapper,
});

export { PageHeaderWithSubComponents as StyledPageHeader };
