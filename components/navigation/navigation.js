            ...
            <div>
                ...
                <div className="nav buttons">
                    ...
                    <div className="icon-buttons buttons">
                        ...
                        <a href="https://github.com/nteract" target="_blank" className="button button-secondary button-icon-only" title="Find us on GitHub.">
                            <div className="button-wrapper">
                                <div className="button-icon">
                                    <svg viewBox="0 0 24 24">
                                        <path fill="#000000"
                        ...
                        <a href="https://twitter.com/nteractio" target="_blank" className="button button-secondary button-icon-only" title="Stay up-to-date with us on Twitter.">
                            <div className="button-wrapper">
                                <div className="button-icon">
                                    <svg viewBox="0 0 24 24">
                                        <path fill="#000000"
