            ...
            <div>
                    ...
                    <div className="panes center-vertically">
                        ...
                        <div className="pane-50 pane">
                            <div className="section-graphic">
                                <img src="https://nteract.io/assets/images/feature_nteract_desktop@2x.png" alt=""/>
                            </div>
                        </div>
                    </div>
                </ContentSection>
                ...
                <ContentSection>
                    <div className="panes center-vertically">
                        <div className="pane-50 pane">
                            <div className="section-graphic">
                                <img src="https://nteract.io/assets/images/feature_nteract_composable@2x.png"
                                     alt=""/>
                            </div>
                        </div>
                        <div className="pane-50 pane">
                ...
                <ContentSection>
                    <div className="panes center-vertically">
                        ...
                        <div className="pane-50 pane">
                            <div className="section-graphic">
                                <img src="https://nteract.io/assets/images/feature_nteract_open_to_all@2x.png"
                                     alt=""/>
                            </div>
                        </div>
                    </div>
