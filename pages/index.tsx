...
class Home extends React.Component<OSProps> {
  static async getInitialProps(ctx: NextPageContext): Promise<OSProps> {
          ...
          <ContentSection>
            <ContentSection.Pane>
              ...
              <Type.p>
                ...
                <a href="applications">applications</a> for your scenario.
                Whether you want to edit notebooks in a desktop app or in your
                favorite editor, nteract provides you the tools you need to
                leverage the full power of interactive notebooks and the Jupyter
                ecosystem.
              </Type.p>
            </ContentSection.Pane>
          ...
          <ContentSection>
            <ContentSection.Pane>
              ...
              <Type.p>
                ...
                <a href="sdk">client-side SDK</a> for integrating notebook and
                REPL UIs into your software. The same SDK used to build the
                nteract suite of applications is available to you!
              </Type.p>
            </ContentSection.Pane>
          ...
          <ContentSection>
            <ContentSection.Pane>
              ...
              <Type.p>
                ...
                ecosystem provides a set of <a href="libraries">libraries</a>{" "}
                for headlessly executing notebooks, managing your team's
                notebooks, using notebooks for reporting and more. Use these
                tools to build an end-to-end notebook experience for you and
                your team.
              </Type.p>
            </ContentSection.Pane>
            <ContentSection.Pane visual>
