...
Most notebook apps don't do this. As far as I know, only Colab secures you from malicious outputs in a notebook attempting to break through. They keep your google identity isolated from rogue notebooks so you can share more easily.
