...
Install the `runt` CLI from the nteract menu (nteract → Install 'runt' Command in PATH), then start the MCP server:

```
runt mcp
```

Point any MCP-capable client at it — Claude Code, Cursor, Warp, OpenCode, you name it. Your agent gets full access to:
